...
# i-ом кусте выросло ai ягод. В этом фермерском хозяйстве внедрена система автоматического
...
# ягоды с этого куста и с двух соседних с ним. Напишите программу для нахождения
...
berries = []
for i in range(bush):
    berries.append(int(input("Введите количество ягод на данном кусте: ")))
print(* berries)
sum = 0
max = 0
i = 1 - bush
